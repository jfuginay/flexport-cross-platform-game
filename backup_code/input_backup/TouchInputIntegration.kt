...
class TouchInputIntegration(
    ...
    fun setInputMode(mode: InputMode) {
        ...
        when (mode) {
            InputMode.NORMAL -> {
                touchInputManager.setInputEnabled(true)
                cameraController.isPanEnabled = true
                cameraController.isZoomEnabled = true
                selectionManager.setSelectionMode(SelectionManager.SelectionMode.MULTIPLE)
                routeCreationHandler.setRouteCreationEnabled(true)
            }
            InputMode.CAMERA_ONLY -> {
                ...
                routeCreationHandler.setRouteCreationEnabled(false)
            }
            ...
            InputMode.DISABLED -> {
                touchInputManager.setInputEnabled(false)
            }
        }
    }
     ...
     */
    fun getSelectedEntities(): Set<Int> = selectionManager.getSelectedEntities()
