...
class TouchInputManager(
    ...
    // Note: setInputEnabled is auto-generated by Kotlin for var isInputEnabled property
    ...
    fun simulateTap(x: Float, y: Float) {
        val worldPos = Vector2(x, y)
        val screenPos = Vector2(x, y)
        ...
        _gestureEvents.tryEmit(tapEvent)
    }
}