...
## Role: Economic Simulation

## Primary Task
Implement supply/demand for 100+ goods, dynamic pricing, futures markets

## Key Requirements
1. Read the full PRD at: /Users/jfuginay/Documents/dev/FlexPort/FlexPort iOS/FlexPort_iOS_Advanced_Features_PRD.md
2. Focus on your specific section (Container 6)
3. Create feature branch: claude-container-6-feature
