# Container 4 Instructions

## Role: ECS Architecture

## Primary Task
Build high-performance ECS supporting 10k+ entities with spatial indexing

## Key Requirements
1. Read the full PRD at: /Users/jfuginay/Documents/dev/FlexPort/FlexPort iOS/FlexPort_iOS_Advanced_Features_PRD.md
2. Focus on your specific section (Container 4)
3. Create feature branch: claude-container-4-feature
