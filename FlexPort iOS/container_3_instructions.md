...
## Role: Gesture & Camera Control

## Primary Task
Implement pinch-zoom, pan, double-tap focus, 3D camera, minimap

## Key Requirements
1. Read the full PRD at: /Users/jfuginay/Documents/dev/FlexPort/FlexPort iOS/FlexPort_iOS_Advanced_Features_PRD.md
2. Focus on your specific section (Container 3)
3. Create feature branch: claude-container-3-feature
