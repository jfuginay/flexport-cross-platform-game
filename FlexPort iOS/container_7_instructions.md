# Container 7 Instructions

## Role: AI Singularity System

## Primary Task
Build AI progression, neural net visualization, quantum computing upgrades

## Key Requirements
1. Read the full PRD at: /Users/jfuginay/Documents/dev/FlexPort/FlexPort iOS/FlexPort_iOS_Advanced_Features_PRD.md
2. Focus on your specific section (Container 7)
3. Create feature branch: claude-container-7-feature
